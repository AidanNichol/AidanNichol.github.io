...
- The large panes where the embroideries are to go were originally placed as circles.
  ...
  Excess backing fabric is trimed away so that it does not cover any of the other panes in design.
...
- Once all the pieces were attached, the whole thing was covered in a layer of acryllic felt and then a layer pollyester fabric (both of which aare sensitive to heat).
  The three layers are temporally pinned together to hold them in place.
- Then, working from the back, the lines of the pattern are machine sown over with a non-heat sensitive thread (cotton or rayon -- not pollyester).
  In the case of the embroideries, the positioning circles are ignored and stich lines that attached them to the backing are stiched over again.
- Then, working from the front, what you see is a bluesheet with the patter stitched in -- a bit like a wholecloth quilt.
- The cloth and felt covering the window panes in the design is cutaway by tracing around the inside of the stitching.
- The excess acryllic felt around the outside of the outer circle is trimed away, right upto the stitch line. The top pollyester sheeting is trimed about 1" outside the stitch line.
- A circlular piece of fabric is placed at the back. The front is folded around and hemmed to the back and the layers are joined by adding ties in the corners of some of the panes so they are completely hidden,
- Finally a circlular sleeve is added to the back (with gaps at three or four points around the circle) and a carbon fibre rod inserted and bent to follow the line of the circle.
  The two ends are joind by inserting them into a small piece of narrow brss tubing.
