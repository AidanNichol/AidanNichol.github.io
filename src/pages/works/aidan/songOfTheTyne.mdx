...
<Image src={import('/src/assets/images/SongTyne/PanelLarge.jpg')} height={180} />
<Image src={import('/src/assets/images/SongTyne/PanelSmall.jpg')} height={180} />
This work focuses on the facets that are associated with the river Tyne.

The main features are

<TextImage left='SongTyne/BridgesOriginal.jpg' right='SongTyne/Bridges.svg'>
  In the top right are the bridges on the river in central Newcastle. The scuplture
  features the Tyne , the Highlevel and the Swing bridges. I've added the Millenium foot
...
<TextImage left='SongTyne/TyneGod1.jpg' right='SongTyne/TyneGod2.jpg'>
  ...
  the frontise piece of a book, *The History of Newcastel-upon-Tyne* 1790. This image was
  derived from one of the sculpted heads on Sommerset House in London, depicting the seven
  river of England
</TextImage>
